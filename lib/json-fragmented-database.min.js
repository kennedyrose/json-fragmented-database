...
(function (root, factory) {
	...
	function getInfo(opt) {
		return new _Promise(function (resolve, reject) {
			...
			getJson(opt.dir + '/info.json').then(function (obj) {
				opt.info = obj;
				resolve(opt);
			}).catch(reject);
		});
	...
	function getData(opt) {
		return new _Promise(function (resolve, reject) {
			...
			function getBatch() {
				...
				getJson(opt.dir + '/' + file + '.json').then(function (arr) {
					var inFileCursor = file * opt.info.entriesPerFile;
	...
	return function (opt, done) {
		...
		getInfo(opt).then(getData).then(function (ret) {
			console.log('Done!');
			done(ret);
		}).catch(console.error);
	};
...
//# sourceMappingURL=json-fragmented-database.min.js.map
